<x-app-layout>
    ...
    <form method="POST" action="{{ route('crypto.processBuyCrypto') }}">
        @csrf
    ...
    <script>
        document.getElementById('bank_account_number').addEventListener('change', function() {
            var selectedOption = this.options[this.selectedIndex];
            document.getElementById('currency').value = selectedOption.value;
        });
    </script>
</x-app-layout>
